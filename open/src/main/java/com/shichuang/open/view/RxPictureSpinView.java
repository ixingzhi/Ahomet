package com.shichuang.open.view;
...
public class RxPictureSpinView extends ImageView implements PictureIndeterminate {
    ...
    private void init() {
        setImageResource(R.drawable.ic_progresshud_spinner);
        mFrameTime = 1000 / 12;
