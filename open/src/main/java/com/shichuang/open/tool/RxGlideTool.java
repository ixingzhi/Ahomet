...
public class RxGlideTool {
    ...
    public static void loadImageView(Context mContext, String path, ImageView mImageView, int errorImageView) {
        RequestOptions options = new RequestOptions();
...
//    }
     ...
     * @param mContext
     */
    private static void clearDiskCache(final Context mContext) {
        //理磁盘缓存 需要在子线程中执行
     ...
     * @param mContext
     */
    private static void clearMemory(Context mContext) {
        //清理内存缓存  可以在UI主线程中进行
